...
/** Phone number, IMSI, IMEI, carrier, Android ID spoofing */
public final class PhoneSpoofHooks {
    ...
    public static void apply(ClassLoader cl, XSharedPreferences p) {
        ...
        hookWifi(cl);
        XposedBridge.log("[AmbulatorSec] Phone spoof active — number=" + num);
    }
    ...
    private static void h(ClassLoader cl, String cls, String method, final String val) {
        try {
            ...
            XposedBridge.log("[AmbulatorSec] skip [" + method + "]: " + t.getMessage());
        }
    }
}
